...
Given a _connected, undirected, non-trivial, matching-covered, non-isomorphic to K4_ graph G=(V, E), this program finds whether <font size="+2"> **G is a Type-2 graph**</font> or not.
